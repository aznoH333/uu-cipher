...
print(plausability("DAIO_DUO_IAWUHID_HIAUWDUIADIU_GWAUIG", krakatit_matrix))


text = "ABM_DEAOMARDHMAVA_VNAERDALD_UAOMAZDNYPAA_VZHBDSVANDAYVWAWIOPABCKVBMARDLMABSDBMAYDOPAXDAWMRDZACYVSANDAYUNDACMWPBSVAHSVBMIAYD"
decrypted_key = break_encryption(text, krakatit_matrix, 60000)
